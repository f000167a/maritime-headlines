...
–sp:#0066aa;–sp-l:#e5f0fa;–hl:#2e7d32;–hl-l:#e8f5e9;
...
.sh{font-size:1em;font-weight:700;padding:10px 16px;color:#fff}.sh.j{background:var(–jmd)}.sh.k{background:var(–kp)}.sh.s{background:var(–sp)}.sh.h{background:var(–hl)}
...
.li .st2.s{background:var(–sp-l);color:var(–sp)}.li .st2.h{background:var(–hl-l);color:var(–hl)}
...
def render_item(a):
sc = a[“src”]
SRC_LABELS = {“j”:“海事新聞”,“k”:“海事プレス”,“s”:“Splash”,“h”:“Hellenic”}
...
# コンソール出力
SRC_LABELS = {"j":"海事新聞","k":"海事ﾌﾟﾚｽ","s":"Splash ","h":"Hellenic"}
